...
сам Django располагается в папке /home/d/dimicowi/dimicowi.beget.tech/public_html/venv/lib/python3.11/site-packages
 
для начала надо переключиться на текущий virtualenv
заходим в папку с проектом
 
$ cd /home/d/dimicowi/dimicowi.beget.tech/public_html
$ source venv/bin/activate
 
проверяем, правильно ли определился путь до pip:
$ which pip
/home/d/dimicowi/dimicowi.beget.tech/public_html/venv/bin/pip
...
$ pwd
/home/d/dimicowi/dimicowi.beget.tech/public_html/HelloDjango/HelloDjango/tmp
$ touch restart.txt